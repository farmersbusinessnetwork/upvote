...
PERMISSIONS.DefineSet('USER', [PERMISSIONS.FLAG, PERMISSIONS.REQUEST_EXEMPTION])
...
EVENT_TYPE.DefineSet('BLOCKED_TYPES', [
  EVENT_TYPE.BLOCK_UNKNOWN, EVENT_TYPE.BLOCK_BINARY,
  EVENT_TYPE.BLOCK_CERTIFICATE, EVENT_TYPE.BLOCK_SCOPE])
...
VOTING_PROHIBITED_REASONS = Namespace(tuples=[
    ('PROHIBITED_STATES', STATE.SET_VOTING_PROHIBITED),
