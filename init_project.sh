...
gcloud kms keys create fbn_santa_sync --purpose=encryption --keyring=ring --location=global
...
bazel run upvote/gae:monolith_binary.deploy -- "${PROJ_ID}" app.yaml santa_api.yaml
